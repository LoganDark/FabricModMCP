...
- [ ] **Phase 23: Type Foundation and ProjectStore** - New container types, compatibility layer, default project at startup
...
**Plans:** 3 plans
Plans:
- [ ] 23-01-PLAN.md — Define new type hierarchy (Project, FabricModChild, StudyJarChild) and compat accessor layer
- [ ] 23-02-PLAN.md — Update core modules (ProjectStore, loader, CLI, dependency-resolver, study-jar) and their tests
- [ ] 23-03-PLAN.md — Migrate all tool files and test factories to use compat accessors, verify full suite
...
| 23. Type Foundation | v1.4 | 0/3 | Not started | - |
