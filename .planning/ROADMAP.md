...
- ✅ **v1.6 Windows Support** — Phases 35-39 (shipped 2026-05-25) — [archive](milestones/v1.6-ROADMAP.md)
...
<details>
<summary>✅ v1.6 Windows Support (Phases 35-39) — SHIPPED 2026-05-25</summary>

- [x] Phase 35: Platform Helpers + Java Executable Resolution (2/2 plans)
- [x] Phase 36: Path / URI Handling Audit (4/4 plans)
- [x] Phase 37: Smarter Java Discovery (cross-platform) (5/5 plans)
- [x] Phase 38: JDT LS Discovery on Windows (1/1 plan)
- [x] Phase 39: Windows End-to-End Validation (6/6 plans)

**5 phases, 18 plans, 15 requirements satisfied (WIN-01..07, JAVA-01..05, UNIX-01..03), 872 tests**
...
| 35-39 | v1.6 | 18/18 | Complete | 2026-05-25 |
